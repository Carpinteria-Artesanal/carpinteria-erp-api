...
const invoices = async ({
  ...
  const invoicesList = await InvoiceModel.find(searchParams, '_id businessName nOrder dateInvoice total dateRegister dateInvoice nInvoice concept payment.type')
    .sort({ nOrder: -1 })
